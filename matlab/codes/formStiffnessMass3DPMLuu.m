function [stiffness,mass] = formStiffnessMass3DPMLuu(stiffness, mass,...
...
for e = pml(i).indx
    ...
    for q = 1:size(gaussWeights,1)
        ...
        C_piezoelectric1 = pml(i).C .* [alpha2*alpha3/alpha1 alpha3 alpha2 alpha3 alpha2*alpha3/alpha1 alpha2*alpha3/alpha1;
