...
gmsh.model.addPhysicalGroup(2, [33, 55, 77, 99, 121, 143, 165, 187, 209, 231, 253, 275], 3)  # 后平面
gmsh.model.addPhysicalGroup(2, [25, 47, 69, 91, 113, 135, 157, 179, 201, 223, 245, 267], 4)  # 前平面
