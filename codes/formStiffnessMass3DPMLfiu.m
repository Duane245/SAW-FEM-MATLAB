function [stiffness,mass] = formStiffnessMass3DPMLfiu(stiffness, ...
...
for e = pml(i).indx
    ...
    elementDoffi = [indice(1) indice(1)+numberNodes indice(1)+2*numberNodes,...
    ...
    for q = 1:size(gaussWeights,1)
        ...
        C_piezoelectric1 = pml(i).e .* [alpha2*alpha3/alpha1 alpha3 alpha2 alpha3 alpha2*alpha3/alpha1 alpha2*alpha3/alpha1;
            alpha3 alpha1*alpha3/alpha2 alpha1 alpha1*alpha3/alpha2 alpha3 alpha3;
            alpha2 alpha1 alpha1*alpha2/alpha3 alpha1 alpha2 alpha2];
