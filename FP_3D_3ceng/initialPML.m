...
pml(2).indx = find(msh.HEXAS27(:,28) == 1008)';
pml(3).indx = find(msh.HEXAS27(:,28) == 1003)';
pml(4).indx = find(msh.HEXAS27(:,28) == 1009)';
...
pml(2).dmax = pml_dmax;
pml(2).n = pml_n;
pml(2).rho = material_type(4).rho;
pml(2).C = material_type(4).C;
pml(2).e = material_type(4).e;
pml(2).eps = material_type(4).eps;

pml(3).za = pml_low_xa;
pml(3).zp = pml_low_xp;
pml(3).dmax = pml_dmax;
pml(3).n = pml_n;
pml(3).rho = material_type(4).rho;
pml(3).C = material_type(4).C;
pml(3).e = material_type(4).e;
pml(3).eps = material_type(4).eps;
...
pml(4).dmax = pml_dmax;
pml(4).n = pml_n;
pml(4).rho = material_type(4).rho;
pml(4).C = material_type(4).C;
pml(4).e = material_type(4).e;
pml(4).eps = material_type(4).eps;
